...
namespace BaukCMS.UI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(_accountHandler.GetUsers());
        }
        ...
        {
            _accountHandler.Activate(userId);
            return RedirectToAction("Index");
        }

        public ActionResult Deactivate(int userId)
        {
            _accountHandler.Deactivate(userId);
            return RedirectToAction("Index");
        }

        public ActionResult Delete(int userId)
        {
            _accountHandler.DeleteUser(userId);
            return RedirectToAction("Index");
        }
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (BaukCMSContext db = new BaukCMSContext())
                {
